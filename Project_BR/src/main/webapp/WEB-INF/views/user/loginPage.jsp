		...
		<form method="post">
			...
			<br />
				<div class="btn">
					...
					<input type="button" value="회원가입" class="submit" onclick="location.href='join_memberPage'" />
					<input type="button" value="홈으로 " class="submit" onclick="location.href='home'" />
					<br /><br />
					<a class="forgot" href="idFindPage">아이디 찾기</a> | <a class="forgot" href="searchPwForm">비밀번호 찾기</a>
				</div>
			</div>
		</form>
	</div>
