	...
	<div>
		<form method="post">
			<div class = "main">
				...
				<%-- 아이디 중복체크 추가해야함 --%>
				<input type="text" class="df" name="uId_" id="uId_" placeholder="아이디" />
				<p>
				...
				<h5 style="color:white">비밀번호 확인</h5>
				...
				<div class="btn">
					<input type="button" id="joinSubmit" class="submit" value="회원가입" onclick="create(this.form)" />
					<input type="reset"  class="submit" value="다시 작성" />
					<input type="button" id="joinSubmit" class="submit" value="홈으로" onclick="location.href='home'" />
				</div>
			</div>
		</form>
	</div>
